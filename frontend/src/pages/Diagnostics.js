      ...
      <div className="flex items-start justify-between gap-4">
        <div>
          <h1 className="font-heading text-3xl font-bold tracking-tight flex items-center gap-3">
            <Activity className="h-8 w-8 text-[#EC4899]" /> Проверка системы
          </h1>
        ...
        <div className="flex gap-2">
          ...
          <Button onClick={run} disabled={loading} className="bg-[#EC4899] hover:bg-[#DB2777]" data-testid="btn-recheck">
          ...
          return (
            <div
              ...
              className={`rounded-lg border p-4 flex items-start gap-3 ${
                c.ok ? (info ? "border-sky-500/30 bg-sky-500/5" : "border-emerald-500/25 bg-emerald-500/5") : "border-[#EC4899]/40 bg-[#EC4899]/10"
              }`}
            ...
            >
              {c.ok ? (
                ...
                <XCircle className="h-5 w-5 text-[#EC4899] shrink-0 mt-0.5" />
              )}
