  ...
  return (
    <div className="space-y-8">
      <PageHeader
        ...
        actions={
          <Button
            className="bg-[#E11D48] hover:bg-[#BE123C] text-white h-11 px-5"
      ...
      <div className="card-premium overflow-hidden">
        <div className="flex items-center justify-between p-5 border-b border-white/10">
          ...
          <Button
            ...
            className="text-[#F43F5E] hover:text-[#F43F5E] hover:bg-[#E11D48]/10"
            onClick={() => navigate("/history")}
        ...
        <Table>
          ...
          <TableBody>
            ...
            {stats && stats.recent.map((c) => (
              <TableRow key={c.id} className="data-row border-white/5" data-testid={`dashboard-row-${c.id}`}>
